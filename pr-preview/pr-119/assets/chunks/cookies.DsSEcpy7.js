import{m as o}from"./main.c2F9in3F.js";customElements.define("esa-cookies",class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.css=`
      ...
      `,this.content="",this.shadowRoot.innerHTML=`
        ...
        `;const e=()=>{this.style.opacity=0};this.shadowRoot.querySelector(".cc-cookie-accept").addEventListener("click",()=>{this.dispatchEvent(new Event("accept")),e()}),this.shadowRoot.querySelector(".cc-cookie-decline").addEventListener("click",()=>{this.dispatchEvent(new Event("decline")),e()})}});
